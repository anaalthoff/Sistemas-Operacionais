...
int main(int argc, char *argv[])
{
  ...
  // strcmp: compara duas strings (s1 e s2) caractere a caractere em ordem lexicográfica (como num dicionário)
  ...
  // Cria uma nova cópia de uma string
  ...
  // strlen: retorna o número de caracteres em uma string (sem contar o terminador '\0')
...
// ao escrever no terminal 'man 3 string' pode ver a documentação da biblioteca de strings em C